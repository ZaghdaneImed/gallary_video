<template>
<div class="panel panel-default" style="float:left;width:34%">
  <div class="panel-heading">
    <h3 style="font-weight: bold;">List Video</h3>
  </div>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        <tr v-for="video in Videos">
          <td>
            <star-rating @rating-selected ="setRating($event, video)"  :rating="video.rating" v-bind:increment="0.5" v-bind:max-rating="5" inactive-color="#000" active-color="#cc1166" v-bind:star-size="30">
            </star-rating>
            <br>
          ...
          <td>
            ...
            <span class="glyphicon glyphicon-trash" v-on:click="removeVideo(video)" style="cursor: pointer"></span>
          </td>
        </tr>
      </tbody>
    </table>
